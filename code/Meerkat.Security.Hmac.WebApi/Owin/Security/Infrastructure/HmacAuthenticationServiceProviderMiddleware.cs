...
namespace Meerkat.Owin.Security.Infrastructure
{
    ...
    /// </summary>
    public class HmacAuthenticationServiceProviderMiddleware : AuthenticationMiddleware<HmacAuthenticationOptions>
    {
        private readonly ILogger logger;
        private readonly IServiceProvider serviceProvider;

        /// <summary>
        /// Create a new instance of the <see cref="HmacAuthenticationServiceProviderMiddleware"/> class.
        /// </summary>
        /// <param name="next"></param>
        /// <param name="options"></param>
        /// <param name="app"></param>
        /// <param name="serviceProvider"></param>
        public HmacAuthenticationServiceProviderMiddleware(OwinMiddleware next, IAppBuilder app, IServiceProvider serviceProvider, HmacAuthenticationOptions options) : base(next, options)
        {
